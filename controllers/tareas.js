...
module.exports.update = (req,res) => {
    connection.query('update tareas set ? where id = ?',[{nombre_tarea: req.body.tarea},req.body.id], (error,results) => {
         if (error) {throw error}
...
module.exports.delete = (req,res) => {
    connection.query('delete from tareas where id = ?',[req.params.id], (error,results) => {
         if (error) {throw error}
